...
def train(
    ...
    df_train = sort_by_group_and_position(df_train)
    df_val = sort_by_group_and_position(df_val)
    ...
    model_params["lambdarank_unbiased"] = True
    model_params["lambdarank_bias_norm"] = 1
