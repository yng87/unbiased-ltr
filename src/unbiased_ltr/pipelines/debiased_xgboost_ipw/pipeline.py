    ...
    base_pipelie = Pipeline(
        [
            node(
                ...
                outputs="model_debiased_xgboost_ipw",
                name="train_debiased_xgboost_ipw_node",
            ),
            node(
                func=predict,
                inputs=[
                    "model_debiased_xgboost_ipw",
                    "web30k_fold1_test_preprocessed",
                ],
                outputs="predictions_debiased_xgboost_ipw",
                name="predict_debiased_xgboost_ipw_node",
            ),
            node(
                func=evaluate,
                inputs=["predictions_debiased_xgboost_ipw", "params:k"],
                outputs="metrics_debiased_xgboost_ipw",
                name="evaluate_debiased_xgboost_ipw_node",
            ),
        ]
    )
